 ...
 * used in the builder's template picker and the /templates gallery so each of the 5 layout
 * engines (single, sidebar, compact, timeline, header-centered) is visually recognizable
 * at a glance.
 */
